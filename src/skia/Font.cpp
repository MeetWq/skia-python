...
void initFontDeclarations(py::module &m) {
// FontStyle
...
void initFontDefinitions(py::module &m) {
auto fontstyle = static_cast<py::class_<SkFontStyle>>(m.attr("FontStyle"));
...
auto fontparameters = static_cast<py::class_<SkFontParameters>>(m.attr("FontParameters"));

auto variation = static_cast<py::class_<SkFontParameters::Variation>>(fontparameters.attr("Variation"));

auto axis = static_cast<py::class_<Axis>>(variation.attr("Axis"));
axis
    .def(py::init<>())
    .def("__repr__",
        [] (const Axis& self) {
...
auto fontarguments = static_cast<py::class_<SkFontArguments>>(m.attr("FontArguments"));

auto variationposition = static_cast<py::class_<SkFontArguments::VariationPosition>>(fontarguments.attr("VariationPosition"));

auto coordinate = static_cast<py::class_<Coordinate>>(variationposition.attr("Coordinate"));
coordinate
    .def(py::init(
...
auto typeface = static_cast<py::class_<SkTypeface, sk_sp<SkTypeface>, SkRefCnt>>(m.attr("Typeface"));
...
auto fontstyleset = static_cast<py::class_<SkFontStyleSet, sk_sp<SkFontStyleSet>, SkRefCnt>>(m.attr("FontStyleSet"));
fontstyleset
...
auto fontmgr = static_cast<py::class_<SkFontMgr, sk_sp<SkFontMgr>, SkRefCnt>>(m.attr("FontMgr"));
fontmgr
...
auto font = static_cast<py::class_<SkFont>>(m.attr("Font"));
...
auto fontmetrics = static_cast<py::class_<SkFontMetrics>>(m.attr("FontMetrics"));
