...
auto autocanvasrestore = static_cast<py::class_<SkAutoCanvasRestore>>(m.attr("AutoCanvasRestore"));
autocanvasrestore
...
auto savelayerrec = static_cast<py::class_<SkCanvas::SaveLayerRec>>(canvas.attr("SaveLayerRec"));
savelayerrec
    .def(py::init<>(),
        R"docstring(
