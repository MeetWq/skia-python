...
auto stream = static_cast<py::class_<SkStream, PyStream<>>>(
    m.attr("Stream"));
stream
    .def("read",
...
auto streamrewindable = static_cast<py::class_<SkStreamRewindable,
    PyStreamRewindable<>, SkStream>>(m.attr("StreamRewindable"));
streamrewindable
    .def("duplicate", &SkStreamRewindable::duplicate)
    ;

auto streamseekable = static_cast<py::class_<SkStreamSeekable, PyStreamSeekable<>,
    SkStreamRewindable>>(m.attr("StreamSeekable"));
streamseekable
    .def("fork", &SkStreamSeekable::fork)
    ;

auto streamasset = static_cast<py::class_<SkStreamAsset, PyStreamAsset<>,
    SkStreamSeekable>>(m.attr("StreamAsset"));
streamasset
    .def("duplicate", &SkStreamSeekable::duplicate)
    .def("fork", &SkStreamSeekable::fork)
    ;

auto streammemory = static_cast<py::class_<SkStreamMemory, PyStreamMemory<>,
    SkStreamAsset>>(m.attr("StreamMemory"));
streammemory
    .def("duplicate", &SkStreamSeekable::duplicate)
    .def("fork", &SkStreamSeekable::fork)
    ;
...
auto nullwstream = static_cast<py::class_<SkNullWStream, PyWStreamImpl<SkNullWStream>,
    SkWStream>>(m.attr("NullWStream"));
nullwstream
    .def(py::init<>())
    ;

auto filestream = static_cast<py::class_<SkFILEStream, PyStreamImpl<SkFILEStream>,
    SkStreamAsset>>(m.attr("FILEStream"));
filestream
...
auto memorystream = static_cast<py::class_<SkMemoryStream, PyMemoryStream<>,
    SkStreamMemory>>(m.attr("MemoryStream"));
memorystream
    .def(py::init<>())
...
auto filewstream = static_cast<py::class_<SkFILEWStream, PyWStreamImpl<SkFILEWStream>,
    SkWStream>>(m.attr("FILEWStream"));
filewstream
    .def(py::init(
        [] (const std::string& path) {
...
auto dynamicmemorywstream = static_cast<py::class_<SkDynamicMemoryWStream,
    PyWStreamImpl<SkDynamicMemoryWStream>, SkWStream>>(m.attr("DynamicMemoryWStream"));
dynamicmemorywstream
    .def(py::init<>())
    .def("read",
