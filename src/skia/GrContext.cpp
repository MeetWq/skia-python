...
auto grbackendsemaphore = static_cast<py::class_<GrBackendSemaphore>>(
    m.attr("GrBackendSemaphore"));
grbackendsemaphore
    .def(py::init())
/*
    .def("initGL",
...
auto grcontextoptions = static_cast<py::class_<GrContextOptions>>(
    m.attr("GrContextOptions"));
grcontextoptions
    .def(py::init<>())
    // TODO: Implement me!
    ;
...
/* m118: Remove GrBackendSurfaceMutableState */
/*
auto grbackendsurfacemutablestate = static_cast<py::class_<GrBackendSemaphore>>(
    m.attr("GrBackendSurfaceMutableState"));
...
auto grbackendrendertarget = static_cast<py::class_<GrBackendRenderTarget>>(
    m.attr("GrBackendRenderTarget"));
...
auto grcontext_base = static_cast<py::class_<GrContext_Base,
    sk_sp<GrContext_Base>, SkRefCnt>>(m.attr("GrContext_Base"));
grcontext_base
...
auto grrecordingcontext = static_cast<py::class_<GrRecordingContext,
    sk_sp<GrRecordingContext>, GrImageContext>>(m.attr("GrRecordingContext"));
grrecordingcontext
...
auto grdirectcontext = static_cast<py::class_<GrDirectContext,
    sk_sp<GrDirectContext>, GrRecordingContext>>(m.attr("GrDirectContext"));
grdirectcontext
