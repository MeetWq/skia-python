...
auto shader = static_cast<py::class_<SkShader, sk_sp<SkShader>, SkFlattenable>>(m.attr("Shader"));
...
auto perlinnoiseshader = static_cast<py::class_<std::unique_ptr<uint32_t>>>(m.attr("PerlinNoiseShader"));
perlinnoiseshader
