...
auto cliperator = static_cast<py::class_<SkRegion::Cliperator>>(region.attr("Cliperator"));
cliperator
...
auto iterator = static_cast<py::class_<SkRegion::Iterator>>(region.attr("Iterator"));
iterator
    .def(py::init<>(),
        R"docstring(
...
auto spanerator = static_cast<py::class_<SkRegion::Spanerator>>(region.attr("Spanerator"));
spanerator
