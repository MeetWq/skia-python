...
auto grglframebufferinfo = static_cast<py::class_<GrGLFramebufferInfo>>(m.attr("GrGLFramebufferInfo"));
grglframebufferinfo
    .def(py::init<>())
...
auto grglinterface = static_cast<py::class_<GrGLInterface, sk_sp<GrGLInterface>, SkRefCnt>>(m.attr("GrGLInterface"));
grglinterface
    .def(py::init([] {
