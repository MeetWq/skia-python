...
auto patheffect = static_cast<py::class_<SkPathEffect, sk_sp<SkPathEffect>,
    SkFlattenable>>(m.attr("PathEffect"));
...
auto discretepatheffect = static_cast<py::class_<SkDiscretePathEffect>>(
    m.attr("DiscretePathEffect"));
discretepatheffect
...
auto dashpatheffect = static_cast<py::class_<SkDashPathEffect>>(
    m.attr("DashPathEffect"));
dashpatheffect
    .def_static("Make",
...
auto cornerpatheffect = static_cast<py::class_<SkCornerPathEffect>>(
    m.attr("CornerPathEffect"));
cornerpatheffect
...
auto path1dpatheffect = static_cast<py::class_<SkPath1DPathEffect>>(
    m.attr("Path1DPathEffect"));
path1dpatheffect
    .def_static("Make",
...
auto line2dpatheffect = static_cast<py::class_<SkLine2DPathEffect>>(
    m.attr("Line2DPathEffect"));
line2dpatheffect
    .def_static("Make", &SkLine2DPathEffect::Make,
        py::arg("width"), py::arg("matrix"))
    ;

auto path2dpatheffect = static_cast<py::class_<SkPath2DPathEffect>>(
    m.attr("Path2DPathEffect"));
path2dpatheffect
...
auto trimpatheffect = static_cast<py::class_<SkTrimPathEffect>>(
    m.attr("TrimPathEffect"));
trimpatheffect
