...
auto grmocktextureinfo = static_cast<py::class_<GrMockTextureInfo>>(m.attr("GrMockTextureInfo"));
grmocktextureinfo
    .def(py::init<>())
...
auto grmockrendertargetinfo = static_cast<py::class_<GrMockRenderTargetInfo>>(m.attr("GrMockRenderTargetInfo"));
