...
auto colorfilter = static_cast<py::class_<SkColorFilter, sk_sp<SkColorFilter>, SkFlattenable>>(m.attr("ColorFilter"));
...
auto colormatrixfilter = static_cast<py::class_<SkColorMatrixFilter, sk_sp<SkColorMatrixFilter>, SkColorFilter>>(m.attr("ColorMatrixFilter"));
colormatrixfilter
...
auto highcontrastconfig = static_cast<py::class_<SkHighContrastConfig>>(m.attr("HighContrastConfig"));
...
auto highcontrastfilter = static_cast<py::class_<SkHighContrastFilter>>(m.attr("HighContrastFilter"));
highcontrastfilter
    .def_static("Make", &SkHighContrastFilter::Make, py::arg("config"))
    ;

auto lumacolorfilter = static_cast<py::class_<SkLumaColorFilter>>(m.attr("LumaColorFilter"));
lumacolorfilter
    .def_static("Make", &SkLumaColorFilter::Make);

auto overdrawcolorfilter = static_cast<py::class_<SkOverdrawColorFilter>>(m.attr("OverdrawColorFilter"));
overdrawcolorfilter
...
auto tablecolorfilter = static_cast<py::class_<std::unique_ptr<uint8_t>>>(m.attr("TableColorFilter"));
tablecolorfilter
    .def_static("Make",
