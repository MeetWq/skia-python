...
auto transferfunction = static_cast<py::class_<skcms_TransferFunction>>(skcms.attr("TransferFunction"));
transferfunction
    .def(py::init(
...
auto colorspace = static_cast<py::class_<SkColorSpace, sk_sp<SkColorSpace>>>(m.attr("ColorSpace"));
colorspace
    .def("toProfile",
